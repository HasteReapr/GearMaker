...
namespace AsukaMod.Survivors.Asuka
{
    public static class AsukaTokens
    {
        ...
        public static void AddAsukaTokens()
        {
            ...
            string desc = "Asuka is a skilled fighter who makes use of a wide arsenal of weaponry to take down his foes.<color=#CCD3E0>" + Environment.NewLine + Environment.NewLine
            ...
            Language.Add(prefix + "NAME", "Asuka");
            ...
            Language.Add(prefix + "PRIMARY_SLASH_DESCRIPTION", Tokens.agilePrefix + $"Swing forward for <style=cIsDamage>{100f * AsukaStaticValues.swordDamageCoefficient}% damage</style>.");
            #endregion

            #region Secondary
            Language.Add(prefix + "SECONDARY_GUN_NAME", "Handgun");
            Language.Add(prefix + "SECONDARY_GUN_DESCRIPTION", Tokens.agilePrefix + $"Fire a handgun for <style=cIsDamage>{100f * AsukaStaticValues.gunDamageCoefficient}% damage</style>.");
            #endregion
            ...
            Language.Add(prefix + "SPECIAL_BOMB_DESCRIPTION", $"Throw a bomb for <style=cIsDamage>{100f * AsukaStaticValues.bombDamageCoefficient}% damage</style>.");
            #endregion
